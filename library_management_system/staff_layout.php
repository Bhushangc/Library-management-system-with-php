...
?>
    ...
    <body>
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="fetch_books.php">Library Management System</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="fetch_books.php">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="add_book.php">Add New Book</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="user_request.php">User Request</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="staff_history.php">History</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="log_staff.php">My log</a>
            </li>
          </ul>
          <div class="dropdown">
